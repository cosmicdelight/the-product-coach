...
export const SECTION_CHAT_CONFIG: Record<SectionType, SectionChatConfig> = {
  problem_identification: {
    ...
    quickPrompts: [
      { label: 'Show me a strong example', message: 'Can you show me an example of a strong problem statement for a public service proposal?' },
  ...
  opportunity_framing: {
    ...
    quickPrompts: [
      { label: 'Show me a strong HMW', message: 'Can you show me a strong How Might We statement for a public service context?' },
